...
function Home() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen w-full overflow-x-hidden">
            ...
            <div id="features" className="w-full relative min-h-screen" style={{ background: 'var(--background-gradient)' }}>
                <JobHunter />
            </div>
            <div className="w-full relative min-h-screen" style={{ background: 'var(--background-gradient)' }}>
                <CareerBuilder />
            </div>
        </div>
    );
